# Available .CEO One-Word Domains (9,282)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C282%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C282%20domains-6f42c1">
  <img alt="formats" src="https://img.shields.io/badge/formats-CSV%20%7C%20JSON-f59e0b">
  <img alt="license" src="https://img.shields.io/badge/license-see%20LICENSE-6b7280">
</p>

Daily-updated dataset of available and resale .ceo one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 9,282 rows · **Live catalog:** 9,282 domains
...
- `ceo.csv` — public CSV extract (9,282 rows)
- `ceo.json` — public JSON extract (9,282 rows)
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------- |
| silver.ceo     | available | $124.98   | —             | 56             | 99     | 6      | namecheap   |
| swift.ceo      | resell    | —         | —             | 68             | 84     | 5      | Dynadot LLC |
| power.ceo      | premium   | $518.96   | $518.96       | 98             | 62     | 5      | namecheap   |
| polo.ceo       | available | $19.99    | —             | 76             | 80     | 4      | name.com    |
| omega.ceo      | resell    | —         | —             | 78             | 71     | 5      | Dynadot LLC |
| enterprise.ceo | premium   | $258.70   | $258.70       | 68             | 61     | 10     | namecheap   |
| converse.ceo   | available | $19.99    | $141.99       | 64             | 73     | 8      | name.com    |
| mini.ceo       | resell    | —         | —             | 70             | 70     | 4      | Dynadot LLC |
...
| true.ceo       | premium   | $248.75   | $248.75       | 86             | 52     | 4      | name.com    |
...
| ----------------------- | ------------------------------------------------ |
| 9,282-row public sample | 9,282 live domains                               |
...
> Unique Domains. *Available .CEO One-Word Domains*. Version 2026-04-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
